    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <div class="flex items-center justify-center h-15 p-2 " style="margin-top: 5px">
                    <a href="{{ route('dashboard') }}" wire:navigate>
                        <x-application-logo-invert class="h-16 w-auto fill-current text-gray-800" />
                    </a>
                </div>
            ...
            <div class="hidden sm:flex sm:items-center sm:ms-6">
                ...
                <div class="mr-4">
                    <input type="text"
                        class="rounded-md border-gray-300 focus:border-indigo-500 focus:ring-indigo-500 w-full sm:max-w-xs"
                ...
                <x-dropdown align="right" width="48">
                    <x-slot name="trigger">
                        <button
                            class="inline-flex items-center px-3 py-2 border border-transparent text-sm leading-4 font-medium rounded-md text-white bg-red-700 hover:bg-red-600 focus:outline-none transition ease-in-out duration-150">
                            <!-- Imagen circular -->
                            <div class="mr-2">
